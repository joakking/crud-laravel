  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Tareas y Notas Joa</h1>
        <p class="lead text-body-secondary">Este es un espacio para anotar las tareas, los links de los recursos y todo lo que consideremos que vale la pena documentar.</p>
        <p>
